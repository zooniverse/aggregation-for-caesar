...
expected_v2 = {
    ...
    'frame0': {
        ...
        'T0_toolIndex1_shape': 'freehandLine',
        'T0_toolIndex1_pathX': [
            [
                0.0,
                1,
...
TestPolygon_v2 = ExtractorTest(
    extractors.polygon_extractor,
    classification_v2,
    expected_v2,
    'Test polygon with v2 inputs',
    test_name='TestPolygon_v2'
)

TestPolygonTask_v2 = ExtractorTest(
    extractors.polygon_extractor,
    classification_v2,
    expected_v2,
    'Test polygon with task specified with v2 inputs',
    kwargs={
        'task': 'T0'
    },
    test_name='TestPolygonTask_v2'
)
