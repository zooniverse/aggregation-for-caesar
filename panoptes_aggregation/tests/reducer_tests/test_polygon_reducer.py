...
processed_data_different_format = {
    'shape': 'freehandLine',
    'n_classifications': 4,
    'frame0': {
        'T0_toolIndex0': {
...
reduced_data_union_different_format = {
    'frame0': {
...
TestPolygonTReducerUnionDifferentExtractionFormat = ReducerTest(
    ...
    process_data,
    extracted_data_different_format,
    copy.deepcopy(processed_data_different_format),
    reduced_data_union_different_format,
...
TestPolygonTReducerNoOverallIntersection = ReducerTest(
    ...
    process_data,
    extracted_data_no_overall_intersection,
    copy.deepcopy(processed_data_no_overall_intersection),
    reduced_data_no_overall_intersection,
