...
reduced_data = {
    'frame0': {
        'T0_toolIndex0_cluster_labels': [0, 1, 2, 0, 1, 2, 0, 1, 2, -1, -1, -1],
        'T0_toolIndex0_clusters_count': [3, 3, 3],
        'T0_toolIndex0_consensus': [0.5723807679762805, 0.6353380315630046, 0.7645350003018981],
        'T0_toolIndex0_clusters_x': [
            [
                -0.06253880643091841,
                -0.3894572368218461,
                -0.49223768418803526,
        ...
        'T0_toolIndex1_consensus': [0.5723807679762805],
        'T0_toolIndex1_clusters_x': [
            [
                -0.06253880643091841,
                -0.3894572368218461,
                -0.49223768418803526,
...
reduced_data_freehand = copy.deepcopy(reduced_data)
reduced_data_freehand['data'] = data_freehand

TestFreehandReducer_collab = ReducerTest(
    polygon_reducer,
    process_data,
    extracted_data_freehand,
    copy.deepcopy(processed_data_freehand),
    reduced_data_freehand,
    'Test freehand line reducer with collab',
    kwargs={
        'eps': 0.5,
        'min_samples': 2,
        'average_type': 'union',
    ...
    test_name='TestFreehandReducer_collab'
)
...
processed_data_polygon = copy.deepcopy(processed_data_freehand)
processed_data_polygon['shape'] = 'polygon'
...
data_polygon = [
    {
        ...
        'toolType': 'polygon',
        'points': [
            {'x': -0.06253880643091841, 'y': -0.5007448417839794},
            {'x': -0.3894572368218461, 'y': -0.3714972196452143},
            {'x': -0.49223768418803526, 'y': -0.03531752424854295},
            {'x': -0.49223768418803493, 'y': -0.03531752424854333},
            {'x': -0.2934843753237021, 'y': 0.2546440769562919},
            {'x': -0.2610963698935616, 'y': 0.25699003001207604},
            {'x': -0.21996918242654376, 'y': 0.3708687043107462},
            {'x': 0.11185711391672837, 'y': 0.4832779309024998},
            {'x': 0.40663249794462797, 'y': 0.2939316921253496},
            {'x': 0.44238509316213026, 'y': -0.05458843226212788},
            {'x': 0.4111953308040009, 'y': -0.08516218748775546},
            {'x': 0.3434907042620213, 'y': -0.30661404249608026},
            {'x': 0.06665584265632145, 'y': -0.453809749424531},
            {'x': 0.035708140618821, 'y': -0.44434808739102644},
            {'x': -0.06253880643091841, 'y': -0.5007448417839794}
        ]
    },
    {
        ...
        'points': [
            ...
            {'x': 5.265583865476678, 'y': 3.582822690557349},
            {'x': 4.98163291632684, 'y': 3.5327544770244548},
            {'x': 4.7454457013476254, 'y': 3.698134545381657},
            {'x': 4.726741378282931, 'y': 3.8042120327267175},
            {'x': 4.630602319839481, 'y': 3.855330076852154},
            {'x': 4.630602319839481, 'y': 3.8553300768521543},
            {'x': 4.658295462956292, 'y': 4.012385695938597},
            {'x': 4.644384004088639, 'y': 4.235275578910275},
            {'x': 4.707699854782151, 'y': 4.292571925109859},
            {'x': 4.719344427837162, 'y': 4.358611580573953},
            {'x': 4.791954327443189, 'y': 4.368816236472241},
            {'x': 4.897477295041295, 'y': 4.4643070245969305},
            {'x': 5.162772021619619, 'y': 4.420931264734213},
            {'x': 5.225416400970543, 'y': 4.429735358097605},
            {'x': 5.24259169742927, 'y': 4.394520781788013},
            {'x': 5.401312969268549, 'y': 4.111517487484036},
            {'x': 5.391901686905876, 'y': 4.088389936777963},
    ...
    },
    {
        ...
        'points': [
            ...
            {'x': -2.3213831520236607, 'y': 1.943211297266067},
            {'x': -2.347496085003458, 'y': 2.047944550980137},
            {'x': -2.2716074328809563, 'y': 2.1212293704700755},
            {'x': -2.262440502917424, 'y': 2.186455466379812},
            {'x': -2.0695264316885313, 'y': 2.360156076316269},
            {'x': -1.8100930795620302, 'y': 2.3692156886043496},
            {'x': -1.81009307956203, 'y': 2.3692156886043496},
            {'x': -1.6055321952784525, 'y': 2.2093952099680867},
            {'x': -1.5599064027625509, 'y': 1.9947427327289593},
            {'x': -1.5113901500303277, 'y': 1.9139981287461882},
            {'x': -1.561128116636017, 'y': 1.8242684617394296},
            {'x': -1.5606417364245644, 'y': 1.8223176972608863},
            {'x': -1.5640152526307798, 'y': 1.8190599305289143},
            {'x': -1.7136491045398121, 'y': 1.5491133158798083},
            {'x': -1.8459444260649625, 'y': 1.5468040924528874},
            {'x': -1.855054617117701, 'y': 1.53800648321691},
            {'x': -1.8834523076541, 'y': 1.546149389944429},
            {'x': -2.1307780991919705, 'y': 1.5418323021947127},
            {'x': -2.1853949812266844, 'y': 1.6327300583550457},
            {'x': -2.2484817914071478, 'y': 1.6508199100765353},
            {'x': -2.2855174523162423, 'y': 1.7993618327116296},
            {'x': -2.3456481393346444, 'y': 1.8994361013759973}
        ]
    },
    {
...
reduced_data_polygon = copy.deepcopy(reduced_data)
reduced_data_polygon['data'] = data_polygon

TestPolygonReducer_collab = ReducerTest(
    polygon_reducer,
    process_data,
    extracted_data_polygon,
    copy.deepcopy(processed_data_polygon),
    reduced_data_polygon,
    'Test polygon reducer with collab',
    kwargs={
        'eps': 0.5,
        'min_samples': 2,
        'average_type': 'union',
...
processed_data_mixed = copy.deepcopy(processed_data_freehand)
processed_data_mixed['shape'] = None

# the collab wrapper does nothing in this case as only one shape is supported at a time
reduced_data_mixed = copy.deepcopy(reduced_data)

TestPolygonReducer_collab_mixed = ReducerTest(
    polygon_reducer,
    process_data,
    extracted_data_mixed,
    copy.deepcopy(processed_data_mixed),
    reduced_data_mixed,
    'Test polygon reducer with collab and mix of shape inputs',
    kwargs={
        'eps': 0.5,
        'min_samples': 2,
        'average_type': 'union',
    ...
    output_kwargs=True,
    network_kwargs=kwargs_extra_data,
    test_name='TestPolygonReducer_collab_mixed'
)
