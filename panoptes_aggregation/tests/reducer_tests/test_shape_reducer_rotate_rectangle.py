...
reduced_data = {
    'frame0': {
        ...
        'T0_tool0_shape': ['rotateRectangle', 'rotateRectangle'],
        ...
        'T0_tool1_shape': ['rotateRectangle', 'rotateRectangle'],
    ...
    'frame1': {
        ...
        'T0_tool1_shape': ['rotateRectangle'],
...
TestShapeReducerRotateRectangleCollabTrue = CollabTest(
    shape_reducer_optics,
    extracted_data,
    data_collab_true,
    ...
    network_kwargs=kwargs_extra_data,
    test_name='TestShapeReducerRotateRectangleCollabTrue'
)
